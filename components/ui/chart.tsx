...
// Purpose: shadcn/ui Chart primitive — wraps Recharts with theme-aware container, tooltip, legend.
// Layer: UI primitive (shadcn registry, "new-york" style)
// Exports: ChartContainer, ChartTooltip, ChartTooltipContent, ChartLegend, ChartLegendContent, ChartStyle
// Depends on: recharts, lib/utils
...
function ChartContainer({
  ...
  React.useEffect(() => {
    ...
    // Recharts warns when ResponsiveContainer mounts before CSS layout has
    // produced real dimensions, so observe this shell and render once positive.
    const updateSize = () => {
